...
import KitItemForm from "../forms/KitItemForm"
...
class KitItemManagement extends Component {
    constructor() {
        super();
    ...
    handleSubmit = (values, i) => {
        ...
        const action = this.state.selected?.id ? API.kit_items.update : API.kit_items.store;
    ...
    handleDelete = (record) => {
        Modal.confirm({
            ...
            onOk: () => {
                this.setState({loading : true});
                API.kit_items.delete(record.id)
                    .then(res => {
    ...
    render() {
        ...
        return (
            ...
            <Fragment>
                ...
                <KitItemForm ref={this.formRef} onCancel={this.hideAddForm} onSubmit={this.handleSubmit} submitting={submitting} visible={visibleAddForm} />
