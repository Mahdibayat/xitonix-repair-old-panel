...
import CheckoutPagePrintView from "../views/CheckoutPagePrintView"
...
class CheckoutPageManagement extends Component {
    constructor() {
        super();
    ...
    showPrint = async(item = {}) => {

        await this.getReception(item.id)
    ...
    render() {
        const { visiblePrint, data, loading, submitting, pagination, selected, visibleAddForm, cityList } = this.state;
        ...
        
        {
            ...
            render: (val, record) => (
                <Fragment>
                    ...
                    <Tooltip title={Resources.checkout_page}>
                        <Button type="link" icon={<PrinterFilled />} onClick={() => this.showPrint(record)} />
                    </Tooltip>
    ...
    const onFinish = (values) => {
        ...
        return (
            ...
            <Fragment>
                {menuHeader}
                <Breadcrumb>
                    <Breadcrumb.Item>{Resources.checkout_page}</Breadcrumb.Item>
                </Breadcrumb>
                                <hr />
                ...
                <CheckoutPagePrintView ref={this.formRef} 
                data={selected}
                onClose={this.hidePrint} 
                 submitting={submitting} visible={visiblePrint} />
