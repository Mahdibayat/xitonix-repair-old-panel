...
class CustomerManagement extends Component {
    ...
    handleSubmit = (values, i) => {
        ...
        const action = this.state.selected?.id ? API.customer.update : API.customer.store;
    ...
    render() {
        ...
        return (
            ...
            <Fragment>
                <Breadcrumb>
                    <Breadcrumb.Item>{Resources.customers}</Breadcrumb.Item>
                </Breadcrumb>
                <Row gutter={24}>
                    <Col xs={24} md={4}>
                ...
                <CustomerForm ref={this.formRef} onCancel={this.hideAddForm} onSubmit={this.handleSubmit} submitting={submitting} visible={visibleAddForm} />
