...
class WaitConfirmManagement extends Component {
    constructor() {
        super();
    ...
    render() {
        const { cityList, data, loading, submitting, pagination, selected, visibleAddForm } = this.state;
    ...
    const onFinish = (values) => {
        ...
        return (
            ...
            <Fragment>
                {menuHeader}
                <Breadcrumb>
                    <Breadcrumb.Item>{Resources.wait_to_confirm}</Breadcrumb.Item>
                </Breadcrumb>
                  <hr />
